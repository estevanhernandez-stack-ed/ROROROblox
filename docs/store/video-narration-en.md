...
(`docs/videos/rororo-launch-16x9.mp4` and its 9:16 / 1:1 / 4:5 social
cuts, which live in the 626labs-hub repo). Source of truth:
`626labs-hub/assets/video/rororo/rororo-launch-script.md`.

**Return format:** copy this file to `video-narration-<lang>.md`
(`fr`, `de`, `ru`, `pt-BR`, `pl`, `es` — same tags as
`docs/store/translations/ui-*.json`), translate every VO and OVERLAY
value, keep the keys and structure untouched. Localized audio renders
