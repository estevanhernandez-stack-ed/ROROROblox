...
| Compat-only push | Signs and re-attaches `roblox-compat.json` + `.sig` to the current latest release with no tag and no binary. | `.github/workflows/compat.yml` | `workflow_dispatch` | active (unverified: added 2026-08-30, never run) |
