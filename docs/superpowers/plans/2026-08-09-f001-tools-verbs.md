...
public class ShellOpenerTests
{
    ...
    public void OpenLogFolderCommand_OpensTheLogDirectory()
    {
        ...
        try
        {
            ...
            Assert.Equal(new[] { ROROROblox.App.AppLogging.LogDirectory }, opener.Opened);
        }
        finally { File.Delete(path); }
    }
...
public class TrayWiringTests
{
    ...
    public void EveryTrayRequestEventHasAHandler()
    {
        ...
        // ITrayService names the events Request<X>; TrayHandlers names the delegates <X> — with two
        // deliberate spellings that differ, mapped here rather than renaming a shipped interface.
        ...
        var missing = events
            .Select(e => aliases.TryGetValue(e, out var a) ? a : e)
            .Where(e => !handlerNames.Contains(e))
            .ToList();
